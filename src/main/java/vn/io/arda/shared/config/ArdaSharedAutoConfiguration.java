 ...
 * </p>
 * <ul>
 * <li>JPA Auditing with {@code @EnableJpaAuditing} for automatic timestamp and
 * user tracking</li>
 ...
 *
 * <p>
 * <strong>JPA Auditing Configuration:</strong>
 * </p>
 * <p>
 * JPA Auditing is enabled with
 * {@code auditorAwareRef = "securityAuditorAware"}, which uses
 * {@link vn.io.arda.shared.persistence.auditing.SecurityAuditorAware} to
 * automatically populate:
 * </p>
 * <ul>
 * <li>{@code createdBy} and {@code updatedBy} fields in
 * {@link vn.io.arda.shared.persistence.entity.AuditableEntity}</li>
 * <li>{@code createdAt} and {@code updatedAt} fields in
 * {@link vn.io.arda.shared.persistence.entity.BaseEntity}</li>
 * </ul>
 *
...
@EnableConfigurationProperties({
        ...
        vn.io.arda.shared.config.properties.ArdaMigrationProperties.class
})
